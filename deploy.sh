gcloud run deploy --project=padicare-425808 \
    ...
    --set-env-vars "PRODUCTION_DATABASE_URL=postgresql+psycopg2://rendis:rendis@34.128.116.217:5432/padicare?host=/cloudsql/padicare-425808:asia-southeast2:padicare-db" \
